...
export const getStudentsInCohort = cohortId => {
    const arrCohortStudents = students.filter(function(student){
        return student.cohort === cohortId
    })
    return arrCohortStudents
}
...
export const getFullTimeStudents = () => {
    const arrFullTimeStudents = students.filter(function(student){
        return student.fullTime
    })
    return arrFullTimeStudents
}
...
export const getPolyglotStudents = languageCount => {
    const arrOfPolyglotStudents = students.filter(function(student){
        return student.languages.length >= languageCount
    })
    return arrOfPolyglotStudents
}
...
export const getStudentsByLanguage = (language) => {
    return students.filter(function(student){
        return student.languages.some(languageId => languageId.includes(language))
    })
}        
